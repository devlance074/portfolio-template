      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
            Here are some of the projects I've worked on, showcasing my skills in web development, mobile apps, and design.
          </p>
        </motion.div>
          ...
          <AnimatePresence>
            {filteredProjects.map((project, index) => (
              <motion.div
                ...
                whileHover={{ y: -5 }}
                className="bg-white dark:bg-gray-900 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer"
            ...
            >
              ...
              >
                <div className="relative">
                  {/* Image Slider */}
                  <div className="relative h-64 sm:h-80 md:h-96 overflow-hidden rounded-t-xl">
                    <img
